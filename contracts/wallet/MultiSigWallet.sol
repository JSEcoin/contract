...
contract MultiSigWallet {
    ...
    /*
     * Additiona event for accepting ERC223 tokens
    */
    event ERC223TokensReceived(address _tokenAddress,address _senderAddress,uint _amount,bytes _data);
    ...
    function tokenFallback(address _from, uint _value, bytes _data) public {
        if (_value > 0) {
            emit ERC223TokensReceived(msg.sender,_from,_value,_data);
        }
    }
